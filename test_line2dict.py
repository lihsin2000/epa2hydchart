...
def test_line2dict():
    ...
    try:
        ...
        lines1 = ["  ID1  123  456  \n"]
        result1 = utils.line2dict(lines=lines1, l=0, position=2)
        ...
        result2 = utils.line2dict(lines=lines2, l=0, position=2)
        ...
        lines3 = ["  ID3  -123  456  \n"]
        result3 = utils.line2dict(lines=lines3, l=0, position=2)
