...
def setup_ui_elements():
    ...
    globals.main_window.ui.l_velocity_threshold.setText(str(globals.VELOCITY_THRESHOLD_DEFAULT))
    globals.main_window.ui.l_velocity_threshold.setValidator(QDoubleValidator())
    globals.main_window.ui.l_pressure_threshold.setText(str(globals.PRESSURE_THRESHOLD_DEFAULT))
    globals.main_window.ui.l_pressure_threshold.setValidator(QDoubleValidator())
